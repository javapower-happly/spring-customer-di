...
public class DiAnnotationBeanPostProcessor extends InstantiationAwareBeanPostProcessorAdapter
    ...
    public DiAnnotationBeanPostProcessor() {
        this.diAnnotationTypes.add(DiAnnotation.class);
        try {
     ...
     * to be autowired.
     */
    public void setDiAnnotationType(Class<? extends Annotation> autowiredAnnotationType) {
        Assert.notNull(autowiredAnnotationType, "'autowiredAnnotationType' must not be null");
        this.diAnnotationTypes.clear();
        this.diAnnotationTypes.add(autowiredAnnotationType);
    }
     ...
     * to be autowired.
     */
    public void setdiAnnotationTypes(Set<Class<? extends Annotation>> diAnnotationTypes) {
        Assert.notEmpty(diAnnotationTypes, "'diAnnotationTypes' must not be empty");
        this.diAnnotationTypes.clear();
        this.diAnnotationTypes.addAll(diAnnotationTypes);
    }
    ...
    private class DiFieldElement extends InjectionMetadata.InjectedElement {
        ...
        protected void inject(Object bean, @Nullable String beanName, @Nullable PropertyValues pvs) throws Throwable {
            ...
            if (field.getType().isInterface()) {
                value = DiProxy.proxyInstance(field, context);
            }
            ...
            /**
             ...
             this.cachedFieldValue = new DiAnnotationBeanPostProcessor.ShortcutDependencyDescriptor(
